  ...
  return (
    <div className="md:mx-40 mx-2">
      <div className="flex align-center gap-5 items-center">
        ...
        <h2 className="pt-10 md:w-[630px] md:text-[16px] text-[12px]">
      ...
      <div className="">
        <>
          ...
          >
            ...
            {shoes.map((shoe) => (
              <SwiperSlide key={shoe.id} shoe={shoe}>
                <div>
                  {/* ######################################################## */}
                  <div
                  ...
                  >
                    <img
                      src={shoe.image}
                      alt={shoe.name}
                      className={`w-full md:h-32 h-20 object-cover rounded-t-lg transition duration-300 transform ${
