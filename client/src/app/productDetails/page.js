        ...
        <div>
          ...
          <div className="w-1/3 space-y-2 pt-4">
            <div className="flex justify-between">
              ...
              <span className="text-gray-800 text-start">PataPata</span>
            </div>
            <div className="flex justify-between">
              <p className="font-semibold">Product Code: </p>
              <span className="text-gray-800 text-start">8726214</span>
            </div>
            <div className="flex justify-between">
          ...
          <div className="flex  py-4 items-center">
            <p className="text-3xl pr-4 line-through font-medium text-gray-600">
              Tk 349.00
            </p>
            <p className="text-3xl font-medium pr-3 text-red-600">Tk 262.00</p>
            <p className="bg-red-700 text-xs p-2 text-white">24%</p>
          </div>
          {/* Offer */}
          ...
          <p className="font-medium text-red-600 pb-4 underline">
            <span className="text-black">*</span>Upto 20% Cashback T&C
          </p>
          {/* Details */}
          ...
          <div>
            <div className="pt-4 flex justify-between">
              ...
              <p className="text-black font-light flex items-center">
          ...
          <div className="pt-5 space-y-4">
            ...
            <button className="bg-black border-2 border-gray-500 p-5 rounded-full"></button>
          </div>
          {/* Promo code */}
          <div className="pt-5 space-y-4">
            <p className="text-black font-semibold ">
              Promocode <span className="text-red-600">*</span>
            </p>
            <input
              type="text"
              className="text-lg px-3 py-2 w-full border border-gray-400 rounded outline-none"
              defaultValue={"#MPC#384"}
            />
          </div>
          {/* Quantity*/}
          <div className="pt-5 space-y-4">
          ...
          <div className="pt-5 space-y-4">
            <div className="flex items-center gap-4">
              <button className="text-xl font-semibold bg-black py-3  w-full rounded-md text-white hover:bg-red-600 transition-colors 0.5s ease-in-out">
                ADD TO CART
              </button>
              <FiHeart
            ...
            <button className="text-xl border border-gray-900 font-semibold hover:bg-black py-3  w-full rounded-md hover:text-white transition-colors 0.5s ease-in-out">
              ADD TO CART
            </button>
          </div>
        </div>
          ...
          {activeTab === "page2" && (
            <div>
              ...
              <div className="pt-12">
                ...
                <h2 className="text-black font-medium pb-5">For Shoes:</h2>
                ...
                <h2 className="text-black font-medium pb-5 pt-10">
                  For Non Footwear (Bags, Belts, Wallets)
                </h2>
